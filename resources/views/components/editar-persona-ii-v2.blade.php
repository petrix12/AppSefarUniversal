...
<!-- Modal -->
<div class="modal fade" id="editarPersona{{ $id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="flex w-full h-auto justify-center items-center">
                    ...
                    <div class="flex w-1/12 h-auto justify-center cursor-pointer" data-dismiss="modal">
            ...
            <div class="modal-footer">
                <button type="button" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" data-dismiss="modal">Cancelar</button>
