            ...
            window.paypal.Buttons({
                ...
                onApprove: function (data, actions) {
                    return actions.order.capture().then(function (details) {
                        ...
                        // Ejemplo simple: mostrar un alert (temporal)
                        Swal.fire({
                            icon: 'success',
                            title: 'Pago realizado con éxito por ' + details.payer.name.given_name,
                            showConfirmButton: true
                        }).then(() => {
                            // Aquí podrías redirigir a una ruta o hacer tu lógica de guardado
                            window.location.href = "{{ route('gracias') }}";
                        });
                    });
                },
