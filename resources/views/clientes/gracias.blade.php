...
@section('content')
    ...
    @if (auth()->user()->servicio == 'Gestión Documental')
        ...
        <script type="text/javascript">
            Swal.fire({
                ...
                html: '<p>En Sefar Universal estamos muy complacido por tenerlo entre nuestros clientes.</p><p>En las proximas horas, estaremos comunicándonos con usted para atender su solicitud de <b>Gestión Documental</b>.</p><p>Por favor presione el botón de <strong>Continuar</strong> para que sea redirigido a nuestra plataforma de carga genealógica.</p><small><p><strong>Nota: </strong>Si ya usted era cliente antiguo de Sefar Universal, toda su información del genealógica estará disponible para a continuación.</p></small></span>',
    ...
    @else if (auth()->user()->servicio == 'Recurso de Alzada')
        @csrf
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.2/jquery.min.js" integrity="sha512-tWHlutFnuG0C6nQRlpvrEhE4QpkG1nn2MOUMWmUeRePl4e3Aki0VB6W1v3oLjFtd0hVOtRQ9PHpSfN6u6/QXkQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        <script type="text/javascript">
            Swal.fire({
                icon: 'success',
                title: '¡Pago procesado correctamente!',
                html: '<p>En Sefar Universal estamos muy complacido por tenerlo entre nuestros clientes.</p><p>En las proximas horas, estaremos comunicándonos con usted para atender su solicitud del <b>Recurso de Alzada</b>.</p><p>Por favor presione el botón de <strong>Continuar</strong> para que sea redirigido a nuestra plataforma de carga genealógica.</p><small><p><strong>Nota: </strong>Si ya usted era cliente antiguo de Sefar Universal, toda su información del genealógica estará disponible para a continuación.</p></small></span>',
                    showDenyButton: false,
                    confirmButtonText: 'Continuar',
                    denyButtonText: 'Volver a la Página Principal',
            }).then((result) => {
