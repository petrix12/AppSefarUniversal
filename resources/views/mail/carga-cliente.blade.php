                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://app.universalsefar.com"
                                ...
                                <img src="https://1.bp.blogspot.com/-etZLVgh-Qn8/YFFkEMlCOrI/AAAAAAAAmlI/xf0ehLF8904Y3ehvw_ToKOHw1eDBUZakACLcBGAsYHQ/s0/LogoSefar_sm.png"
                                    class="logo" alt="Logo Sefar"
                                ...
                                @php
                                    ...
                                    for ($i = 1; $i <= 31; $i++) {
                                        if (existePer($agclientes, $i)) {
                                            $cargadas = $cargadas . '<br>' . GetPersona($i);
                                        } else {
                                            $no_cargadas = $no_cargadas . '<br>' . GetPersona($i);
                                        }
                                    }
                                @endphp
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        @if ($no_cargadas == '')
                                            <p
                                                ...
                                                Gracias por actualizar su información genealógica.
                                                Mientras más datos proporciones más fácil y rápido
                                                será la realización de tu estudio genealógico.
                                            </p>
                                        @else
                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            ...
                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                {{-- Cliente: {{ $agclientes }} --}}
                                                {{-- <strong>Personas cargadas:</strong>{!! $cargadas !!} <br> --}}
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Si no posee la documentación, le podemos ofrecer el siguiente servicio
                                            <br>
                                            <a href="https://www.sefaruniversal.com/asistencia-documental"
                                                target="_blank">
                                                Asistencia documental de Sefar Universal
                                            </a>
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
