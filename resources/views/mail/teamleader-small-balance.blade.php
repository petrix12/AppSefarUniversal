...
<ul>
    ...
    <li><strong>Monto preestablecido:</strong> {{ format_money((float) data_get($payment, 'payment_data.effective_preestab_amount', 0), 2, ',', '.') }} EUR</li>
    <li><strong>Monto registrado:</strong> {{ format_money((float) data_get($payment, 'payment_data.effective_paid_amount', 0), 2, ',', '.') }} EUR</li>
    <li><strong>Diferencial:</strong> {{ format_money((float) data_get($payment, 'payment_data.balance_amount', 0), 2, ',', '.') }} EUR</li>
</ul>
