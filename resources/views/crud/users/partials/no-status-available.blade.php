<div class="alert alert-info text-center my-5 p-5 shadow-sm"
     role="alert"
     style="max-width: 700px; margin: 0 auto; background-color: rgba(0,0,0,0.05); border: 1px solid #b6e0fe; border-radius: 15px;">
