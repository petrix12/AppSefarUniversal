                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">{{ __('Edit family member') }}</span>
                                        </h2>
                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('crud.families.update', $family) }}" method="POST">
                                    ...
                                    <div class="shadow overflow-hidden sm:rounded-md">
                                            <div class="container">
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- IDCliente --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('IDCliente', $family->IDCliente) }}" type="text" name="IDCliente" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('IDCliente')
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Cliente --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('Cliente', $family->Cliente) }}" type="text" name="Cliente" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('Cliente')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                {{-- Fila 2: Famliar --}}
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{--  --}}
                                                        <div>
                                                            <label for="IDFamiliar" class="block text-sm font-medium text-gray-700">ID Familiar</label>
                                                            <input value="{{ old('IDFamiliar', $family->IDFamiliar) }}" type="text" name="IDFamiliar" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('IDFamiliar')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Familiar --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('Familiar', $family->Familiar) }}" type="text" name="Familiar" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('Familiar')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="Parentesco" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                ...
                                                                @foreach ($parentescos as $parentesco)
                                                                    @if (old('Parentesco', $parentesco->Parentesco) == $family->Parentesco)
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="Lado" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                ...
                                                                @foreach ($lados as $lado)
                                                                    @if (old('Lado', $lado->Lado) == $family->Lado)
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="Rama" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                ...
                                                                @foreach ($connections as $connection)
                                                                    @if (old('Rama', $connection->Conexion) == $family->Rama)
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Nota --}}
                                                        <div>
                                                            ...
                                                            <textarea name="Nota" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Notas...">{{ old('Nota', $family->Nota) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
