                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">{{ __('Edit person') }}</span>
                                        </h2>
                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('crud.agclientes.update', $agcliente) }}" method="POST">
                                    ...
                                    <div class="shadow overflow-hidden sm:rounded-md">
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- IDCliente --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('IDCliente', $agcliente->IDCliente) }}" type="text" name="IDCliente" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('IDCliente')
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Nombres --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('Nombres', $agcliente->Nombres) }}" type="text" name="Nombres" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('Nombres')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Apellidos --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('Apellidos', $agcliente->Apellidos) }}" type="text" name="Apellidos" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('Apellidos')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- IDPersona --}}
                                                        <div>
                                                            ...
                                                            <select name="IDPersona" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                @for ($i = 1; $i <=31; $i++)
                                                                    @if ( old('IDPersona', $agcliente->IDPersona) == $i)
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- NPasaporte --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('NPasaporte', $agcliente->NPasaporte) }}" type="text" name="NPasaporte" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="PaisPasaporte" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                ...
                                                                @foreach ($countries as $country)
                                                                    @if (old('PaisPasaporte', $agcliente->PaisPasaporte) == $country->pais)
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- NDocIdent --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('NDocIdent', $agcliente->NDocIdent) }}" type="text" name="NDocIdent" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- PaisDocIdent --}}
                                                        <div>
                                                            ...
                                                            <select name="PaisDocIdent" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @foreach ($countries as $country)
                                                                    @if (old('PaisDocIdent', $agcliente->PaisDocIdent) == $country->pais)
                                                                        <option selected>{{ $country->pais }}</option>
                                                                    @else
                                                                        <option>{{ $country->pais }}</option> 
                                                                    @endif
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- AnhoNac --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('AnhoNac', $agcliente->AnhoNac) }}" min="0" max="3000" type="number" name="AnhoNac" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('AnhoNac')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- MesNac --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('MesNac', $agcliente->MesNac) }}" min="1" max="12" type="number" name="MesNac" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('MesNac')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- DiaNac --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('DiaNac', $agcliente->DiaNac) }}" min="1" max="31" type="number" name="DiaNac" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('DiaNac')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- LugarNac --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('LugarNac', $agcliente->LugarNac) }}" type="text" name="LugarNac" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- PaisNac --}}
                                                        <div>
                                                            ...
                                                            <select name="PaisNac" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @foreach ($countries as $country)
                                                                    @if (old('PaisNac', $agcliente->PaisNac) == $country->pais)
                                                                        <option selected>{{ $country->pais }}</option>
                                                                    @else
                                                                        <option>{{ $country->pais }}</option> 
                                                                    @endif
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- AnhoBtzo --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('AnhoBtzo', $agcliente->AnhoBtzo) }}" min="0" max="3000" type="number" name="AnhoBtzo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('AnhoBtzo')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- MesBtzo --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('MesBtzo', $agcliente->MesBtzo) }}" min="1" max="12" type="number" name="MesBtzo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('MesBtzo')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- DiaBtzo --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('DiaBtzo', $agcliente->DiaBtzo) }}" min="1" max="31" type="number" name="DiaBtzo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('DiaBtzo')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- LugarBtzo --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('LugarBtzo', $agcliente->LugarBtzo) }}" type="text" name="LugarBtzo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- PaisBtzo --}}
                                                        <div>
                                                            ...
                                                            <select name="PaisBtzo" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @foreach ($countries as $country)
                                                                    @if (old('PaisBtzo', $agcliente->PaisBtzo) == $country->pais)
                                                                        <option selected>{{ $country->pais }}</option>
                                                                    @else
                                                                        <option>{{ $country->pais }}</option> 
                                                                    @endif
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- AnhoMatr --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('AnhoMatr', $agcliente->AnhoMatr) }}" min="0" max="3000" type="number" name="AnhoMatr" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('AnhoMatr')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- MesMatr --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('MesMatr', $agcliente->MesMatr) }}" min="1" max="12" type="number" name="MesMatr" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('MesMatr')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- DiaMatr --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('DiaMatr', $agcliente->DiaMatr) }}" min="1" max="31" type="number" name="DiaMatr" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('DiaMatr')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- LugarMatr --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('LugarMatr', $agcliente->LugarMatr) }}" type="text" name="LugarMatr" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- PaisMatr --}}
                                                        <div>
                                                            ...
                                                            <select name="PaisMatr" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @foreach ($countries as $country)
                                                                    @if (old('PaisMatr', $agcliente->PaisMatr) == $country->pais)
                                                                        <option selected>{{ $country->pais }}</option>
                                                                    @else
                                                                        <option>{{ $country->pais }}</option> 
                                                                    @endif
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- AnhoDef --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('AnhoDef', $agcliente->AnhoDef) }}" min="0" max="3000" type="number" name="AnhoDef" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('AnhoDef')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- MesDef --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('MesDef', $agcliente->MesDef) }}" min="1" max="12" type="number" name="MesDef" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('MesDef')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- DiaDef --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('DiaDef', $agcliente->DiaDef) }}" min="1" max="31" type="number" name="DiaDef" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('DiaDef')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- LugarDef --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('LugarDef', $agcliente->LugarDef) }}" type="text" name="LugarDef" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- PaisDef --}}
                                                        <div>
                                                            ...
                                                            <select name="PaisDef" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @foreach ($countries as $country)
                                                                    @if (old('PaisDef', $agcliente->PaisDef) == $country->pais)
                                                                        <option selected>{{ $country->pais }}</option>
                                                                    @else
                                                                        <option>{{ $country->pais }}</option> 
                                                                    @endif
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- Familiaridad --}}
                                                        <div>
                                                            ...
                                                            <select name="Familiaridad" autocomplete="on" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @if (old('Familiaridad', $agcliente->Familiaridad) == "Si")
                                                                    <option selected>Si</option>
                                                                @else
                                                                    <option>Si</option>
                                                                @endif
                                                                
                                                                @if (old('Familiaridad', $agcliente->Familiaridad) == "No")
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- NombresF --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('NombresF', $agcliente->NombresF) }}" type="text" name="NombresF" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- ApellidosF --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('ApellidosF', $agcliente->ApellidosF) }}" type="text" name="ApellidosF" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- ParentescoF --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('ParentescoF', $agcliente->ParentescoF) }}" type="text" name="ParentescoF" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    <div class="px-1 py-2 m-2 flex">    {{-- NPasaporteF --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('NPasaporteF', $agcliente->NPasaporteF) }}" type="text" name="NPasaporteF" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex">    {{-- FRegistro --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('FRegistro', $agcliente->FRegistro) }}" type="date" name="FRegistro" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Enlace --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('Enlace', $agcliente->Enlace) }}" type="url" name="Enlace" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- Observaciones --}}
                                                        <div>
                                                            ...
                                                            <textarea name="Observaciones" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Observaciones">{{ old('Observaciones', $agcliente->Observaciones) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        {{-- Fila 8 Campos en desusos --}}
                                        <div class="container">
                                            <div class="flex flex-col">
                                                <div class="px-4 py-2 m-2">
                                                    <label class="block text-sm font-medium text-gray-700">Campos en desusos:</label>
                                                </div>
                                                <div class="px-10">
                                                    <small>PNacimiento: {{ $agcliente->PNacimiento }}</small>
                                                </div>
                                                <div class="px-10">
                                                    <small>LNacimiento: {{ $agcliente->LNacimiento }}</small>
                                                </div>
                                                <div class="px-10">
                                                    <small>Familiares: {{ $agcliente->Familiares }}</small>
                                                </div>
                                            </div>
                                        </div>
