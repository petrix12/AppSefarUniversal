                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">{{ __('Edit document') }}</span>
                                        </h2>
                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('crud.libraries.update', $library) }}" method="POST">
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- documento --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('documento', $library->documento) }}" type="text" name="documento" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('documento')
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="tipo" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                ...
                                                                @foreach ($t_files as $t_file)
                                                                    @if (old('formato', $library->tipo) == $t_file->tipo)
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="formato" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                ...
                                                                @foreach ($formats as $format)
                                                                    @if (old('formato', $library->formato) == $format->formato)
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- fuente --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('fuente', $library->fuente) }}" type="text" name="fuente" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('fuente')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- origen --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('origen', $library->origen) }}" type="text" name="origen" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('origen')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- ubicacion --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('ubicacion', $library->ubicacion) }}" type="text" name="ubicacion" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('ubicacion')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- ubicacion_ant --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('ubicacion_ant', $library->ubicacion_ant) }}" type="text" name="ubicacion_ant" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('ubicacion_ant')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- busqueda --}}
                                                        <div>
                                                            ...
                                                            <textarea name="busqueda" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Escriba aquí palabras claves">{{ old('busqueda', $library->busqueda) }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- notas --}}
                                                        <div>
                                                            ...
                                                            <textarea name="notas" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Notas">{{ old('notas', $library->notas) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- enlace --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('enlace', $library->enlace) }}" type="text" name="enlace" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('enlace')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- anho_ini --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('anho_ini', $library->anho_ini) }}" type="number" name="anho_ini" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('anho_ini')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex">    {{-- anho_fin --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('anho_fin', $library->anho_fin) }}" type="number" name="anho_fin" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('anho_fin')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
