...
@section('title', 'Editar Miscelaneo')
                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">{{ __('Edit Miscellaneou') }}</span>
                                        </h2>
                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('crud.miscelaneos.update', $miscelaneo) }}" method="POST">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- titulo --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('titulo', $miscelaneo->titulo) }}" type="text" name="titulo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('titulo')
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- material --}}
                                                        <div>
                                                            ...
                                                            <select name="material" autocomplete="on" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option></option>
                                                                @if (old('material', $miscelaneo->material) == "Artículo de publicación periódica")
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- autor --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('autor', $miscelaneo->autor) }}" type="text" name="autor" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('autor')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1/2">    {{-- paginacion --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('paginacion', $miscelaneo->paginacion) }}" type="text" name="paginacion" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('paginacion')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1/2">    {{-- isbn --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('isbn', $miscelaneo->isbn) }}" type="text" name="isbn" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('isbn')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- claves --}}
                                                        <div>
                                                            ...
                                                            <textarea name="claves" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Escriba aquí palabras claves">{{ old('claves', $miscelaneo->claves) }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- notas --}}
                                                        <div>
                                                            ...
                                                            <textarea name="notas" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Notas">{{ old('notas', $miscelaneo->notas) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- enlace --}}
                                                        <div>
                                                            ...
                                                            <input value="{{ old('enlace', $miscelaneo->enlace) }}" type="text" name="enlace" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                            @error('enlace')
                                                                <small style="color:red">*{{ $message }}*</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="md:flex ms:flex-wrap">
                                                    <div class="px-1 py-2 m-2 flex-1">    {{-- catalogador --}}
                                                        <div>
                                                            <label class="block text-sm font-medium text-blue-700">Catalogado por: {{ $miscelaneo->catalogador ? $miscelaneo->catalogador : 'No registrado' }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
