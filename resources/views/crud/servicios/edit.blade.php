                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">Editar Servicio</span>
                                        </h2>
                                        <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                                            ...
                                            @include('crud.servicios.partials.catalog-fields', ['servicio' => $servicio])
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="md:flex ms:flex-wrap">
                                                <div class="px-1 py-2 m-2 flex-1">    {{-- id_hubspot --}}
                                                    <div>
                                                        ...
                                                        <input value="{{ old('id_hubspot', $servicio->id_hubspot) }}" type="text" name="id_hubspot" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                                        @error('id_hubspot')
                                                ...
                                                <div class="px-1 py-2 m-2 flex-1">    {{-- nombre --}}
                                                    <div>
                                                        ...
                                                        <input value="{{ old('nombre', $servicio->nombre) }}" type="text" name="nombre" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                                        @error('nombre')
                                                            <small style="color:red">*{{ $message }}*</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="px-1 py-2 m-2 flex-1">    {{-- precio --}}
                                                    <div>
                                                        ...
                                                        <input value="{{ old('precio', $servicio->precio) }}" type="number" name="precio" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                                        @error('precio')
                                                            <small style="color:red">*{{ $message }}*</small>
                                                        @enderror
                                                    </div>
