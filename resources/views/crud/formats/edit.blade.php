                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">{{ __('Edit format') }}</span>
                                        </h2>
                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('crud.formats.update', $format) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-12 sm:col-span-12">
                                                    ...
                                                    <input  type="text" 
                                                            name="formato"
                                                            autocomplete="on"
                                                            value="{{ old('formato', $format->formato) }}"
                                                ...
                                                <p>
                                                    <input  type="file" 
                                                            ...
                                                            style="display: none" 
                                                            accept="image/png"
                                                            value="{{ old('file', $format->ubicacion) }}"
                                                    />
