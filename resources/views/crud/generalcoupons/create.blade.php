...
@section('title', 'Añadir Cupón General')
                                ...
                                <div class="bg-gray-50">
                                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                            <span class="ctvSefar block text-indigo-600">Añadir Cupón General</span>
                                        </h2>
                                        <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                                            <div class="inline-flex rounded-md shadow">
                                                <a href="{{ route('generalcoupons.index') }}" class="cfrSefar inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="{{ route('generalcoupons.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="shadow overflow-hidden sm:rounded-md">
                                        <div class="container">
                                            ...
                                            <div class="md:flex ms:flex-wrap">
                                                ...
                                                <div class="px-1 py-2 m-2 flex-1">
                                                    <label for="newdiscount" class="block text-sm font-medium text-gray-700">Nuevo descuento (en Euros)</label>
                                                    <input value="{{ old('newdiscount') }}" type="number" name="newdiscount" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                                    @error('newdiscount')
                                                        <small style="color:red">*{{ $message }}*</small>
                                                    @enderror
                                                </div>
