  ...
  const setupThreeScene = async (shell, canvas, stopFallback, fallbackCanvas) => {
    try {
      ...
      const branchSegments = [
        ...
        [[-0.08, -1.35, 0.05], [-0.56, -0.88, 0.04]],
        [[-0.08, -1.35, 0.05], [0.44, -0.78, -0.05]],
        [[-0.95, 0.15, -0.04], [-1.56, 0.74, 0.02]],
        [[-0.95, 0.15, -0.04], [-0.96, 1.12, 0.05]],
        [[-0.95, 0.15, -0.04], [-0.25, 0.88, -0.02]],
        [[-1.56, 0.74, 0.02], [-1.96, 1.14, 0.08]],
        [[-0.96, 1.12, 0.05], [-1.18, 1.68, 0.1]],
        [[0.02, 0.62, 0.02], [-0.2, 1.62, 0.08]],
        [[0.02, 0.62, 0.02], [0.7, 1.54, -0.02]],
        [[-0.2, 1.62, 0.08], [0.22, 2.02, 0.02]],
        [[0.7, 1.54, -0.02], [1.08, 1.95, -0.05]],
        [[0.86, 0.04, -0.06], [1.3, 0.94, 0.06]],
        [[0.86, 0.04, -0.06], [1.82, 0.58, -0.03]],
        [[1.3, 0.94, 0.06], [1.68, 1.32, 0.08]],
        [[1.82, 0.58, -0.03], [2.18, 0.94, -0.02]],
      ];
      const nodePositions = [
        [-0.56, -0.88, 0.04],
        [0.44, -0.78, -0.05],
