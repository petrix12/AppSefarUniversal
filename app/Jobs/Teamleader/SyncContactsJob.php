<?php
// app/Jobs/Teamleader/SyncContactsJob.php
...
class SyncContactsJob implements ShouldQueue
{
    ...
    {
        Log::info("[TL] Contactos — recolectando todos los IDs...");
        ...
        do {
            ...
            Log::info("[TL] Contactos — página {$page}: " . count($items) . " IDs");
        ...
        $total = count($allIds);
        Log::info("[TL] Contactos — {$total} IDs recolectados. Creando chunks...");
        ...
        Log::info("[TL] Contactos — {$totalChunks} chunks de 20. Despachando...");
        ...
        Log::info("[TL] Contactos — {$totalChunks} chunks despachados.");
    }

    public function failed(\Throwable $e): void
    {
        Log::error("[TL] SyncContactsJob falló: " . $e->getMessage());
