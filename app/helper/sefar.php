...
function mostrarDocumentos($agclientes, $IDPersona, $tipo = 'tree'){
    ...
    if($carpeta){
        switch ($tipo) {
            case 'tree':
                ?>
                <button onclick="document.getElementById('verDocumentos<?php echo $IDPersona; ?>').showModal()"><span class="folder ctrSefar"><i class="far fa-folder-open"></i></span></button>
                <?php
                break;
            case 'albero':
                ?>
                <button onclick="document.getElementById('verDocumentos<?php echo $IDPersona; ?>').showModal()"><span class="documentos ctrSefar"><i class="far fa-folder-open"></i></span></button>
                <?php
                break;
            default:
                return null;
